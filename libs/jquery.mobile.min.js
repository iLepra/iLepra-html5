/*! jQuery Mobile vGit Build: SHA1: 84f1e4f257268b4b8d6132065263702e61074797 <> Date: Wed Feb 29 19:53:52 2012 +0800 jquerymobile.com | jquery.org/license */
...
"enhance")},hijackable:function(a){return this.haveParents(a,"ajax")},haveParents:function(b,f){if(!a.mobile.ignoreContentEnabled)return b;for(var c=b.length,e=a(),g,m,o,l=0;l<c;l++){m=b.eq(l);o=false;for(g=b[l];g;){if((g.getAttribute?g.getAttribute("data-"+a.mobile.ns+f):"")==="false"){o=true;break}g=g.parentNode}o||(e=e.add(m))}return e}},a.mobile);a.fn.jqmData=function(b,c){var e;typeof b!="undefined"&&(e=this.data(b?a.mobile.nsNormalize(b):b,c));return e};a.jqmData=function(b,c,e){var g;typeof c!=
...
c){return a.find(c,null,null,[b]).length>0}})(jQuery,this);(function(a){a(r);var c=a("html");a.mobile.media=function(){var b={},g=a("<div id='jquery-mediatest'>"),e=a("<body>").append(g);return function(a){if(!(a in b)){var f=k.createElement("style"),h="@media "+a+" { #jquery-mediatest { position:absolute; } }";f.type="text/css";f.styleSheet?f.styleSheet.cssText=h:f.appendChild(k.createTextNode(h));c.prepend(e).prepend(f);b[a]=g.css("position")==="absolute";e.add(f).remove()}return b[a]}}()})(jQuery);
...
a.mobile.maxTransitionWidth,l=!a.support.cssTransitions||o||!b||b==="none",o=function(){d&&d.removeClass(a.mobile.activePageClass+" out in reverse "+b).height("");e.addClass(a.mobile.activePageClass);l||e.animationComplete(q);a.mobile.focusPage(e);e.height(k+j);a.mobile.silentScroll(j);e.addClass(b+" in"+h);l&&q()},q=function(){e.removeClass("out in reverse "+b).height("").parent().removeClass(m);f.resolve(b,g,e,d,true)};e.parent().addClass(m);d&&!l?d.animationComplete(o).height(k+a(c).scrollTop()).addClass(b+
" out"+h):o();return f.promise()};a.mobile.transitionHandlers={"default":a.mobile.defaultTransitionHandler};a.mobile.transitionFallbacks={}})(jQuery,this);(function(a,c){function b(b){q&&(!q.closest(".ui-page-active").length||b)&&q.removeClass(a.mobile.activeBtnClass);q=null}function g(){u=false;s.length>0&&a.mobile.changePage.apply(null,s.pop())}function e(b,c,d,f){c&&c.data("page")._trigger("beforehide",null,{nextPage:b});b.data("page")._trigger("beforeshow",null,{prevPage:c||a("")});a.mobile.hidePageLoadingMsg();
d=(a.mobile.transitionHandlers[d||"default"]||a.mobile.defaultTransitionHandler)(d,f,b,c);d.done(function(){c&&c.data("page")._trigger("hide",null,{nextPage:b});b.data("page")._trigger("show",null,{prevPage:c||a("")})});return d}function d(){var b=a.event.special.orientationchange.orientation()==="portrait",c=b?screen.availHeight:screen.availWidth,b=Math.max(b?480:320,a(r).height());return Math.min(c,b)}function f(){var b=a("."+a.mobile.activePageClass),c=parseFloat(b.css("padding-top")),f=parseFloat(b.css("padding-bottom"));
b.css("min-height",d()-c-f)}function h(b,c){c&&b.attr("data-"+a.mobile.ns+"role",c);b.page()}function j(a){for(;a;){if(typeof a.nodeName==="string"&&a.nodeName.toLowerCase()=="a")break;a=a.parentNode}return a}function p(b){var b=a(b).closest(".ui-page").jqmData("url"),c=t.hrefNoHash;if(!b||!l.isPath(b))b=c;return l.makeUrlAbsolute(b,c)}var m=a(r);a("html");var o=a("head"),l={urlParseRE:/^(((([^:\/#\?]+:)?(?:(\/\/)((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?\]\[]+|\[[^\/\]@#?]+\])(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/,
...
a.mobile.activePage&&p(a.mobile.activePage)||t.hrefNoHash);if(e.data&&e.type==="get")k=l.addSearchParams(k,e.data),e.data=c;if(e.data&&e.type==="post")e.reloadPage=true;var v=l.getFilePath(k),m=l.convertUrlToDataUrl(k);e.pageContainer=e.pageContainer||a.mobile.pageContainer;g=e.pageContainer.children(":jqmData(url='"+m+"')");g.length===0&&m&&!l.isPath(m)&&(g=e.pageContainer.children("#"+m).attr("data-"+a.mobile.ns+"url",m));if(g.length===0)if(a.mobile.firstPage&&l.isFirstPageUrl(v))a.mobile.firstPage.parent().length&&
(g=a(a.mobile.firstPage));else if(l.isEmbeddedPage(v))return f.reject(k,d),f.promise();B&&B.reset();if(g.length){if(!e.reloadPage)return h(g,e.role),f.resolve(k,d,g),f.promise();j=g}var n=e.pageContainer,x=new a.Event("pagebeforeload"),o={url:b,absUrl:k,dataUrl:m,deferred:f,options:e};n.trigger(x,o);if(x.isDefaultPrevented())return f.promise();if(e.showLoadMsg)var q=setTimeout(function(){a.mobile.showPageLoadingMsg()},e.loadMsgDelay);!a.mobile.allowCrossDomainPages&&!l.isSameDomain(w,k)?f.reject(k,
d):a.ajax({url:v,type:e.type,data:e.data,dataType:"html",success:function(c,n,p){var x=a("<div></div>"),t=c.match(/<title[^>]*>([^<]*)/)&&RegExp.$1,s=RegExp("\\bdata-"+a.mobile.ns+"url=[\"']?([^\"'>]*)[\"']?");RegExp("(<[^>]+\\bdata-"+a.mobile.ns+"role=[\"']?page[\"']?[^>]*>)").test(c)&&RegExp.$1&&s.test(RegExp.$1)&&RegExp.$1&&(b=v=l.getFilePath(RegExp.$1));B&&B.set(v);x.get(0).innerHTML=c;g=x.find(":jqmData(role='page'), :jqmData(role='dialog')").first();g.length||(g=a("<div data-"+a.mobile.ns+"role='page'>"+
...
a.mobile.ns+"url",l.convertUrlToDataUrl(v)).attr("data-"+a.mobile.ns+"external-page",true).appendTo(e.pageContainer);g.one("pagecreate",a.mobile._bindPageRemove);h(g,e.role);k.indexOf("&"+a.mobile.subPageUrlKey)>-1&&(g=e.pageContainer.children(":jqmData(url='"+m+"')"));e.showLoadMsg&&(clearTimeout(q),a.mobile.hidePageLoadingMsg());o.xhr=p;o.textStatus=n;o.page=g;e.pageContainer.trigger("pageload",o);f.resolve(k,d,g,j)},error:function(b,c,g){B&&B.set(l.get());o.xhr=b;o.textStatus=c;o.errorThrown=g;
b=new a.Event("pageloadfailed");e.pageContainer.trigger(b,o);b.isDefaultPrevented()||(e.showLoadMsg&&(clearTimeout(q),a.mobile.hidePageLoadingMsg(),a.mobile.showPageLoadingMsg(a.mobile.pageLoadErrorMessageTheme,a.mobile.pageLoadErrorMessage,true),setTimeout(a.mobile.hidePageLoadingMsg,1500)),f.reject(k,d))}});return f.promise()};a.mobile.loadPage.defaults={type:"get",data:c,reloadPage:false,role:c,showLoadMsg:false,pageContainer:c,loadMsgDelay:50};a.mobile.changePage=function(d,f){if(u)s.unshift(arguments);
else{var j=a.extend({},a.mobile.changePage.defaults,f);j.pageContainer=j.pageContainer||a.mobile.pageContainer;j.fromPage=j.fromPage||a.mobile.activePage;var v=j.pageContainer,m=new a.Event("pagebeforechange"),p={toPage:d,options:j};v.trigger(m,p);if(!m.isDefaultPrevented())if(d=p.toPage,u=true,typeof d=="string")a.mobile.loadPage(d,j).done(function(b,c,d,e){u=false;c.duplicateCachedPage=e;a.mobile.changePage(d,c)}).fail(function(){u=false;b(true);g();j.pageContainer.trigger("pagechangefailed",p)});
else{if(d[0]===a.mobile.firstPage[0]&&!j.dataUrl)j.dataUrl=w.hrefNoHash;var m=j.fromPage,o=j.dataUrl&&l.convertUrlToDataUrl(j.dataUrl)||d.jqmData("url"),t=o;l.getFilePath(o);var q=n.getActive(),r=n.activeIndex===0,y=0,B=k.title,A=j.role==="dialog"||d.jqmData("role")==="dialog";if(m&&m[0]===d[0]&&!j.allowSamePageTransition)u=false,v.trigger("pagechange",p);else{h(d,j.role);j.fromHashChange&&n.directHashChange({currentUrl:o,isBack:function(){y=-1},isForward:function(){y=1}});try{k.activeElement&&k.activeElement.nodeName.toLowerCase()!=
"body"?a(k.activeElement).blur():a("input:focus, textarea:focus, select:focus").blur()}catch(D){}A&&q&&(o=(q.url||"")+x);if(j.changeHash!==false&&o)n.ignoreNextHashChange=true,l.set(o);var C=!q?B:d.jqmData("title")||d.children(":jqmData(role='header')").find(".ui-title").getEncodedText();C&&B==k.title&&(B=C);d.jqmData("title")||d.jqmData("title",B);j.transition=j.transition||(y&&!r?q.transition:c)||(A?a.mobile.defaultDialogTransition:a.mobile.defaultPageTransition);y||n.addNew(o,j.transition,B,t,
j.role);k.title=n.getActive().title;a.mobile.activePage=d;j.reverse=j.reverse||y<0;e(d,m,j.transition,j.reverse).done(function(c,e,f,h,l){b();j.duplicateCachedPage&&j.duplicateCachedPage.remove();l||a.mobile.focusPage(d);g();v.trigger("pagechange",p)})}}}};a.mobile.changePage.defaults={transition:c,reverse:false,changeHash:true,fromHashChange:false,role:c,duplicateCachedPage:c,pageContainer:c,showLoadMsg:true,dataUrl:c,fromPage:c,allowSamePageTransition:false};a.mobile._registerInternalEvents=function(){a(k).delegate("form",
...
1)&&a.mobile.linkBindingEnabled&&(c=j(c.target),a(c).jqmHijackable().length&&c&&l.parseUrl(c.getAttribute("href")||"#").hash!=="#"))b(true),q=a(c).closest(".ui-btn").not(".ui-disabled"),q.addClass(a.mobile.activeBtnClass),a("."+a.mobile.activePageClass+" .ui-btn").not(c).blur(),a(c).jqmData("href",a(c).attr("href")).attr("href","#")});a(k).bind("click",function(d){if(a.mobile.linkBindingEnabled){var f=j(d.target),e=a(f),g;if(f&&!(d.which>1)&&e.jqmHijackable().length){g=function(){r.setTimeout(function(){b(true)},
200)};e.jqmData("href")&&e.attr("href",e.jqmData("href"));if(e.is(":jqmData(rel='back')"))return r.history.back(),false;var h=p(e),f=l.makeUrlAbsolute(e.attr("href")||"#",h);if(!a.mobile.ajaxEnabled&&!l.isEmbeddedPage(f))g();else{if(f.search("#")!=-1)if(f=f.replace(/[^#]*#/,""))f=l.isPath(f)?l.makeUrlAbsolute(f,h):l.makeUrlAbsolute("#"+f,w.hrefNoHash);else{d.preventDefault();return}var h=e.is("[rel='external']")||e.is(":jqmData(ajax='false')")||e.is("[target]"),k=a.mobile.allowCrossDomainPages&&w.protocol===
"file:"&&f.search(/^https?:/)!=-1;h||l.isExternal(f)&&!k?g():(g=e.jqmData("transition"),h=(h=e.jqmData("direction"))&&h==="reverse"||e.jqmData("back"),e=e.attr("data-"+a.mobile.ns+"rel")||c,a.mobile.changePage(f,{transition:g,reverse:h,role:e}),d.preventDefault())}}}});a(k).delegate(".ui-page","pageshow.prefetch",function(){var b=[];a(this).find("a:jqmData(prefetch)").each(function(){var c=a(this),d=c.attr("href");d&&a.inArray(d,b)===-1&&(b.push(d),a.mobile.loadPage(d,{role:c.attr("data-"+a.mobile.ns+
...
else{n.directHashChange({currentUrl:d,isBack:function(){r.history.back()},isForward:function(){r.history.forward()}});return}d?(d=typeof d==="string"&&!l.isPath(d)?l.makeUrlAbsolute("#"+d,t):d,a.mobile.changePage(d,f)):a.mobile.changePage(a.mobile.firstPage,f)}};m.bind("hashchange",function(){a.mobile._handleHashChange(location.hash)});a(k).bind("pageshow",f);a(r).bind("throttledresize",f)}})(jQuery);(function(a,c){var b={},g=a(c),e=a.mobile.path.parseUrl(location.href);a.extend(b,{initialFilePath:e.pathname+
